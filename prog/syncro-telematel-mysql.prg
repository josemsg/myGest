...
*//......Parámetros: tcDBF, nombre de la tabla DBF a pasar..................................
*//......			 tcDataBase, nombre de la base de datos mySQL...........................
*//......Return:	 _cRet: Contiene el texto del fichero SQL para esta tabla...............
*//......            Recibe como parámetro el nombre de la tabla, el nombre de la base......
*//......            de datos mySQL.........................................................
*//.........................................................................................
*//-----------------------------------------------------------------------------------------
FUNCTION Dbf2Sql
...
*__ Comprobamos los parámetros
IF PCOUNT()<>2
	WAIT WINDOW "DBF2SQL: Nº de parámetros incorrecto" TIMEOUT 3
	RETURN
ENDIF

IF VARTYPE(tcDBF)<>"C"
	WAIT WINDOW "DBF2SQL: parámetro tcDBF incorrecto"
	RETURN
ENDIF

IF VARTYPE(tcDataBase)<>"C"
	WAIT WINDOW "DBF2SQL: parámetro tcDataBase incorrecto"
	RETURN
ENDIF
...
_cRet = _cRet + XCOMM+"*//......Localidad:     Encarnación-Paraguay...xodrf@hotmail.com..............................." + _eol
