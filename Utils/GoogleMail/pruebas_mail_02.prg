...
WITH loMail
  ...
  .Password = "jm01191413jm" && Password
    ...
    WITH loMsg
      ...
      * Ask for Reading Receipt if needed
      IF This.ReadReceipt = .T. 
        .Fields("urn:schemas:mailheader:disposition-notification-to") = "jmsanchez.ibiza@gmail.com"
        .Fields("urn:schemas:mailheader:return-receipt-to") = "jmsanchez.ibiza@gmail.com"
        .Fields.Update()
      ENDIF
