   ...
   PROTECTED PROCEDURE proccesspictures
      ...
      IF FILE(lcfile)
         ...
         IF lipicturemode=0 .OR. lipicturemode=1
            *__ Antes  iseddrawimage(nleft/960, (ntop/960), nwidth/960, nheight/960)
            iseddrawimage(nleft/960, (ntop/960), nwidth/1040, nheight/1020)
         ELSE
            *__ Antes  iseddrawscaledimage(nleft/960, (ntop/960), 1)
